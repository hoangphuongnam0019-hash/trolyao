...
<div class="main-header">
    ...
    <p>Tác giả: Họ và tên - Trường thay bằng trường của mình - ĐT:.... </p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>Họ và tên - Trường thay bằng trường của mình - ĐT:....</div>", unsafe_allow_html=True)
